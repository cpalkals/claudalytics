...
if (args.includes('--help') || args.includes('-h')) {
  console.log(`
coder-agentmeter - See where your coding-agent tokens go
...
Examples:
  ...
  coder-agentmeter --codex-home ~/.codex --no-open
`);
  process.exit(0);
}
...
const server = app.listen(port, async () => {
  ...
  console.log(`\n  coder-agentmeter dashboard running at ${url}\n`);
